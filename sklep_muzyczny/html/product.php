            ...
            <div class="m-[250px_0_108px_0] flex justify-around">
                <header class="max-w-[40%] p-6"> 
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <form action="../handlers/cart_add.php?id=<?php echo $product["Id_produktu"]; ?>" method="post">
                            <button type="submit" class="inline-flex items-center px-3 py-2 text-xl font-semibold text-center text-gray-800 bg-gradient-to-r from-white to-sky-200 rounded-lg shadow">
                                Add to cart
                            ...
                            <label for="count"> Count: 
                                <input type="number" name="count" id="count" min="1" max="10" value="1" class="w-[70px] px-3 py-2 text-xl font-semibold text-center text-gray-800 bg-gradient-to-r from-white to-sky-200 rounded-lg shadow">
                            </label>
                        </form>
