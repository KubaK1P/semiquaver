<div class="basis-[30%] bg-white border border-gray-200 rounded-lg shadow">
    ...
    <div class="p-5">
        ...
        <a href="product.php" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-800 bg-gradient-to-r from-white to-sky-200 rounded-lg shadow">
            Product subpage
