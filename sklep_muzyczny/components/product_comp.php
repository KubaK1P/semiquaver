<div class="basis-[30%] bg-white border border-gray-200 rounded-lg shadow">
    ...
    <div class="p-5">
        ...
        <a href="./product.php?id=0" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-gray-800 bg-gradient-to-r from-white to-sky-200 rounded-lg shadow">
            Product subpage
            <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            </svg>
        </a>
        <p class="text-xl text-gray-700 p-2 font-semibold">100 zł</p>
        </div>
    </div>
</div>